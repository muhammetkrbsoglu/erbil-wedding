    ...
    >
      ...
      >
        <div className="relative overflow-hidden">
          ...
          {/* Rating */}
          <div className="absolute top-4 left-4 flex items-center gap-1 bg-secondary/80 backdrop-blur-sm rounded-full px-2 py-1">
        ...
        <CardContent className="p-6">
          <div className="space-y-4">
            <div>
              <h3 className="text-xl font-playfair font-bold text-text mb-2 group-hover:text-accent transition-colors">
                {name}
              </h3>
            ...
            <div className="flex flex-wrap gap-2">
              {features.slice(0, 3).map((feature, index) => (
                <Badge key={index} variant="secondary" className="text-xs bg-secondary text-text hover:bg-secondary/90">
                  {feature}
                </Badge>
              ))}
              {features.length > 3 && (
                <Badge variant="secondary" className="text-xs bg-secondary text-text">
