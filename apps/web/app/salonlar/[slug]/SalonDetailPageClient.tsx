...
export default async function SalonDetailPageClient({ params }: SalonDetailPageProps) {
      ...
      <section className="relative h-[70vh] overflow-hidden">
        ...
        {salon.videoUrl && (
          <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
            <Button size="lg" className="bg-accent hover:bg-accent/90 text-white rounded-full w-20 h-20 p-0 shadow-2xl">
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
                <CardContent className="p-8">
                  ...
                  <div className="rounded-xl overflow-hidden h-64 mb-4">
                    <GoogleMap
                      center={{ lat: 40.9925, lng: 29.0244 }} // Varsayılan konum
                      zoom={16}
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <Button
                      variant="outline"
                      className="flex-1 border-accent text-accent hover:bg-accent hover:text-white bg-transparent"
                  ...
                  {salon.price && (
                    <div className="mb-6 p-4 bg-accent/10 rounded-lg">
                      ...
                      <p className="text-2xl font-bold text-accent">
                        ₺{salon.price.min.toLocaleString()} - ₺{salon.price.max.toLocaleString()}
                      </p>
                    </div>
                  )}

                  <div className="space-y-4">
                    <Button className="w-full bg-accent hover:bg-accent/90 text-white py-3 text-lg">
